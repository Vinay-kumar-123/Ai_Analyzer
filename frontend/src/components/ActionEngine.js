                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <button
                              ...
                              className="absolute top-3 right-3 bg-gray-800 hover:bg-gray-700 text-white p-2 rounded-lg"
                            >
                              {copied ===
                              `cmd-${i}` ? (
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <button
                              ...
                              className="absolute top-3 right-3 bg-slate-800 hover:bg-slate-700 text-white p-2 rounded-lg"
                            >
                              {copied ===
                              `code-${i}` ? (
                                <CheckCircle2 size={18} />
