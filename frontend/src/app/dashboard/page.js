...
// const CREDIT_PLANS = [
//   { id: "plan_basic", name: "Basic", price: 99, credits: 30 },
//   { id: "plan_pro", name: "Pro", price: 199, credits: 70 },
//   { id: "plan_premium", name: "Premium", price: 299, credits: 120 },
// ];
...
//                 <h3 className="text-2xl font-bold">{stats?.usageCount || 0}</h3>
//               </div>
//             </div>
...
import Navbar from "@/components/Navbar";
import Link from "next/link";
import { Link as LinkIcon, Target, BarChart3 } from "lucide-react";
import toast from "react-hot-toast";
import AnalysisHistory from "@/components/AnalysisHistory";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-2xl p-6 mb-8 shadow-lg">
          <p className="text-sm text-blue-100">Your Credits</p>

          <h2 className="text-5xl font-bold mt-2">{credits}</h2>
          ...
          {credits <= 2 && (
            <p className="text-yellow-300 mt-2 text-sm">
              ⚠️ Low credits — buy more
            </p>
          )}

          <Link href="/buy-credits">
            <button className="mt-5 bg-white text-blue-600 px-5 py-2 rounded-lg font-semibold">
              Buy Credits
            </button>
          </Link>
        </div>
